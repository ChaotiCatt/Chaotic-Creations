...
import net.mcreator.chaoticcreations.block.NullstoneBlock;
import net.mcreator.chaoticcreations.ChaoticCreationsModElements;

@ChaoticCreationsModElements.ModElement.Tag
public class FinalbiomeBiome extends ChaoticCreationsModElements.ModElement {
	public static Biome biome;
	public FinalbiomeBiome(ChaoticCreationsModElements instance) {
		super(instance, 82);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(NullstoneBlock.block.getDefaultState(),
								NullstoneBlock.block.getDefaultState(), NullstoneBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("chaotic_creations:finalbiome"));
			}
		}
	}
	@Override
