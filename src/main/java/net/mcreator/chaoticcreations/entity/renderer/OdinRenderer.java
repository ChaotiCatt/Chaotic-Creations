...
import net.mcreator.chaoticcreations.entity.OdinEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class OdinRenderer {
	...
	public static class Modelcustom_model extends EntityModel<Entity> {
		...
		public Modelcustom_model() {
			...
			cube_r1.setTextureOffset(0, 55).addBox(-3.0F, 7.0F, -8.0F, 4.0F, 6.0F, 1.0F, 0.0F, false);
			cube_r2 = new ModelRenderer(this);
			cube_r2.setRotationPoint(1.0F, 10.5F, 7.0F);
			head.addChild(cube_r2);
			setRotationAngle(cube_r2, -1.4835F, 0.0F, 0.0F);
			cube_r2.setTextureOffset(0, 55).addBox(-3.0F, 6.0F, -12.0F, 4.0F, 6.0F, 2.0F, 0.0F, false);
			cube_r3 = new ModelRenderer(this);
			cube_r3.setRotationPoint(1.0F, 10.5F, 7.0F);
			head.addChild(cube_r3);
			setRotationAngle(cube_r3, -1.1345F, 0.0F, 0.0F);
			cube_r3.setTextureOffset(0, 55).addBox(2.0F, -1.0F, -16.0F, 1.0F, 6.0F, 4.0F, 0.0F, false);
			cube_r3.setTextureOffset(0, 55).addBox(-5.0F, -1.0F, -16.0F, 1.0F, 6.0F, 4.0F, 0.0F, false);
			cube_r3.setTextureOffset(0, 55).addBox(-4.0F, -1.0F, -16.5F, 6.0F, 6.0F, 1.0F, 0.0F, false);
