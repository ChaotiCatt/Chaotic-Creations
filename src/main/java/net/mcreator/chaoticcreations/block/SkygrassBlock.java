...
public class SkygrassBlock extends ChaoticCreationsModElements.ModElement {
	@ObjectHolder("chaotic_creations:skygrass")
	public static final Block block = null;
	public SkygrassBlock(ChaoticCreationsModElements instance) {
		super(instance, 55);
	}
