...
public class ChaoticClusterBlock extends ChaoticCreationsModElements.ModElement {
	@ObjectHolder("chaotic_creations:chaotic_cluster")
	public static final Block block = null;
	@ObjectHolder("chaotic_creations:chaotic_cluster")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public ChaoticClusterBlock(ChaoticCreationsModElements instance) {
		super(instance, 14);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("chaotic_cluster"));
		}
	}

	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.BASALT).hardnessAndResistance(1f, 10f).setLightLevel(s -> 1).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).setRequiresTool().setNeedsPostProcessing((bs, br, bp) -> true)
					.setEmmisiveRendering((bs, br, bp) -> true));
			setRegistryName("chaotic_cluster");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("The chaotic energy is blinding..."));
		}

		@Override
		public float[] getBeaconColorMultiplier(BlockState state, IWorldReader world, BlockPos pos, BlockPos beaconPos) {
			return new float[]{0.38431372549f, 0f, 0f};
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("chaotic_cluster");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Chaotic Cluster");
		}
