...
public class EternalFlameItem extends ChaoticCreationsModElements.ModElement {
	@ObjectHolder("chaotic_creations:eternal_flame")
	public static final Item block = null;
	public EternalFlameItem(ChaoticCreationsModElements instance) {
		super(instance, 8);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("It's hotter than the sun"));
				list.add(new StringTextComponent("touching this will kill those who aren't worthy..."));
			}
