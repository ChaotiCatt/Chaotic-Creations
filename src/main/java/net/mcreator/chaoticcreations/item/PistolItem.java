...
import net.mcreator.chaoticcreations.entity.renderer.PistolRenderer;
import net.mcreator.chaoticcreations.ChaoticCreationsModElements;

import java.util.Random;

@ChaoticCreationsModElements.ModElement.Tag
public class PistolItem extends ChaoticCreationsModElements.ModElement {
	@ObjectHolder("chaotic_creations:pistol")
	...
	public PistolItem(ChaoticCreationsModElements instance) {
		super(instance, 38);
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 9f, 0.2, 5);
